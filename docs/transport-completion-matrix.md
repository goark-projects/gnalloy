...
- SCTP validation covers startup capability snapshots, invalid config/address checks, and readiness-only poller enforcement. Linux native smoke still requires a host with kernel SCTP support.
